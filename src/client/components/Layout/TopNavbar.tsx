...
export default function TopNavbar({ onBurgerClick, isMobileMenuOpen }: TopNavbarProps) {
      ...
      <div className="h-full px-4 lg:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="lg:hidden p-2 -ml-2 rounded-xl text-gray-600 hover:bg-gray-100 transition-all duration-200"
          >
            {isMobileMenuOpen ? (
          ...
          {/* Logo */}
          <NavLink to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity duration-200">
